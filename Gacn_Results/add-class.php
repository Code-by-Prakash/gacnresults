...
if (strlen($_SESSION['admin']) == 0) {
    ...
    if (isset($_POST['submit'])) 
    {
        $cname = $_POST['cname'];
        $classid = $_POST['cid'];
        $query = mysqli_query($con, "INSERT INTO tblclasses (`ClassId`, ClassName, updationDate) 
        VALUES ('$classid', '$cname',  NOW())");

   if ($query) {
    $successmsg = "Added new Class successfully !!";
} else {
    $errormsg = "Class not added !!";
}
    }
                            ...
                            <?php } ?>
                                <form class="form-horizontal style-form" method="post" name="class"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="number" min="1" name="cid" required="required" class="form-control">
                                        </div>
