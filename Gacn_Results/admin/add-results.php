		...
		<section id="container">
			...
			<section id="main-content">
				<section class="wrapper">
					<h3><i class="fa fa-angle-right"></i> Add Results</h3>
								...
								if (isset($_POST['submit'])) {
									...
									if ($result->num_rows > 0) {
										...
										<tr>
											...
											<tr>
												<th colspan="6"  style="text-align: center;">Exam:<?php echo "$examFormatted"?></th>
									</tr>
...
<?php $query=mysqli_query($con,"select Userid, Name, `Batch Start`, `Batch End`,`Degree & Branch` from  tblstudents");
...
<td><a href="javascript:void(0);" onClick="popUpWindow('http://localhost/Result_Analysis/admin/new-results.php?uid=<?php echo htmlentities($row['Userid']);?>&exam=<?php echo htmlentities($exam);?>');" title="Add Results">
<button type="button" class="btn btn-primary">Add Results</button>
											</a>
