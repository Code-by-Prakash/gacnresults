    ...
    if (isset($_POST['submit'])) {
        ...
        if (isset($_FILES['image']) && !empty($_FILES['image']['name'])) {
            ...
            if (!in_array($extension, $allowed_extensions)) {
                ...
                $query = mysqli_query($con, "UPDATE tblstudents SET userImage='$imgnewfile', emailId='$email', updationDate=NOW() WHERE Userid='" . $_SESSION['SUser'] . "'");
                if ($query) {
            ...
            $query = mysqli_query($con, "UPDATE tblstudents SET emailId='$email', mobile='$mobile', updationDate=NOW() WHERE Userid='" . $_SESSION['SUser'] . "'");
            if ($query) {
                $successmsg = "Profile successfully updated !!";
            } else {
                $errormsg = "Profile not updated !!";
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" name="regno" required="required"
                                                value="<?php echo htmlentities($row['Userid']); ?>" class="form-control"
                                                readonly>
                                        </div>
                                    </div>
                                    <div class="form-group">
