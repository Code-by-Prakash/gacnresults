...
<section id="container">
  ...
  <section id="main-content">
    <section class="wrapper">
      <h3><i class="fa fa-angle-right"></i> Results (Subject wise)</h3>
      <div class="row mt">
        <div class="col-lg-12">
...
if (isset($_POST['submit'])) {
    ...
    (tblresults.CIA + tblresults.ESE) AS TotalMarks FROM tblstudents 
        ...
        WHERE DATE_FORMAT(tblresults.MonthYear, '%b %Y') = '" . $_POST['exam'] . "' and tblsubjects.SubjectName='" . $subject_name . "' and tblsubjects.SubjectId='" . $subject_id . "'and tblstudents.Department='" . $department . "' ";
